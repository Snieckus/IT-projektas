...
<?php
                     ...
                     $sql = "SELECT kursaimano.ID, kursaimano.name, kursaimano.notes, kursaimano.date, kursaimano.price FROM ((kursaikursantai
                             INNER JOIN kursaimano ON kursaikursantai.coursesID = kursaimano.ID)
                             INNER JOIN usersmano ON kursaikursantai.usersID = usersmano.userid)
                             WHERE usersmano.username = '".$_SESSION['user']."';";
                     $busena = 0;
                     $eilute = 0;
                     $dabar = date("Y-m-d");                    
                       ...
                       <?php
                        ...
                        else
                        {
                            ...
                            <form action="index.php">
                                <center><input type="submit" value="Užsiregistruoti"/></center>
                            </form>
                            <?php
