...
<?php
    ...
    {                                  // Sesijoje nustatyti kintamieji su reiksmemis is DB
        ...
        ?><hr><center>
        <?php echo "<a href=\"adminStudentai.php\">Grįžti</a> &nbsp;&nbsp;";?>
        </center>
<hr>
...
<?php
                    $naujasID=$_POST['studID'];

                    $_SESSION['pasirinktasStudentasID']=$naujasID;
                    
                    $dbc=mysqli_connect(DB_SERVER, DB_USER, DB_PASS, DB_NAME);
                    if(!$dbc){
                        die ("Negaliu prisijungti prie MySQL:"	.mysqli_error($dbc));
                    }
                    $querisas = "SELECT * FROM usersmano WHERE usersmano.userid = '".$naujasID."' AND usersmano.userlevel='3'";
                    ...
                    if(mysqli_num_rows($resultas) > 0)
                    {
                        ...
                        $_SESSION['pasirinktasStudentas'] = $vardas;
                    }   
                    else
                    {
                        ?>
                        <h1 style="text-align:center"> Pasirinkto studento nėra!</h1>
                        <?php
                    }            
                     ...
                     $sql = "SELECT kursaimano.ID, kursaimano.name, kursaimano.notes, kursaimano.date, kursaimano.price, kursaimano.capacity, usersmano.username
                             ...
                             WHERE usersmano.userid = '".$naujasID."' AND usersmano.userlevel = '3'";
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo $naujasID?> studento kursai</h3>
            ...
            <table class="table">
                ...
                <tbody>
                       <?php
                         ...
                         ?>
                         <br>
                         <form method="POST" action="pridetiKursa.php">
...
<?php
                        ...
                        {           
                            ...
                            if(isset($_SESSION['pasirinktasStudentas']))
                            {
                                ?>
                                <h1 style="text-align:center">Studentas <?php echo "\"".$_SESSION['pasirinktasStudentas']."\"" ?> neturi kursų!</h1>
