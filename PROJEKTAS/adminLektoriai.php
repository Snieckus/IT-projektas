...
{
    unset($_SESSION['pasirinktoLektoriausVardas']);
?>
<div class="container">
<div class="row">
    <?php
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                     ...
                     echo "<br>";
                        ?>
            <p>Iveskite lektoriaus numerį, kurį norite peržiūrėti</p>
                       <form method="POST" action="lektoriausKursai.php">
                            <input type="submit" value="Peržiūrėti">
                            <input type="number" min="1" required name="lektoriausID"> lektorių                            
                       </form>   
